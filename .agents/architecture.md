...
|---|---|---|
| Game Collector | `gfg` durable Schedule/Job/Run/Result/Instance | Redis realtime progress and existing read caches |
| Game Backend | `gfg` | existing Redis cache and non-acquisition maintenance schedules |
| Nav Collector | `gfn` durable Schedule/Job/Run/Result/Instance | Redis realtime progress and existing read caches |
