...
|---|---|---|
| Game Collector | `gfg` durable acquisition ledger, historical eligibility/facts, and fact checkpoints | Redis realtime progress and existing read caches |
| Game Backend | `gfg` | existing Redis cache and non-acquisition maintenance schedules |
| Nav Collector | `gfn` durable acquisition ledger, target/Primary history, historical facts, and fact checkpoints | Redis realtime progress and existing read caches |
