<template>
  <section class="game-stats-card">
    ...
    <div
      v-if="topItem"
      class="game-stats-feature relative z-[1] mt-3 grid min-h-[3.9rem] grid-cols-[2rem_minmax(0,1fr)_5.2rem] items-center gap-2 py-1 sm:grid-cols-[2.2rem_minmax(0,1fr)_5.4rem_5.4rem_3.4rem]"
    >
      ...
      <div class="game-stats-row__value game-stats-row__value--secondary hidden text-right sm:block">
        {{ formatNumber(topItem.count_peak) }}
      </div>

      <div class="game-stats-row__muted hidden text-right sm:block">
        {{ formatTime(topItem.collect_time) }}
      </div>
    </div>
    <div
      v-else
    ...
    <div class="game-stats-table relative z-[1] mt-4 overflow-hidden">
      <div class="game-stats-table-head grid grid-cols-[2rem_minmax(0,1fr)_5.2rem] items-center gap-2 px-2 py-2 sm:grid-cols-[2.2rem_minmax(0,1fr)_5.4rem_5.4rem_3.4rem]">
