...
export const resources: ResourceConfig[] = [
  ...
  },
  {
    ...
    columns: [{ key: 'id', label: 'ID' }, { key: 'name', label: '名称' }, { key: 'appid', label: 'Steam AppID' }],
    fields: [
    ...
    defaults: { name: '', name_en: '', info: '', info_en: '', resources: [{ key: '', value: '' }], groups: kvDefaults(groupKeys), developers: [''], publishers: [''], appid: 0, header: '', links: kvDefaults(linkKeys), weight: 1000, primary_tag: '', secondary_tag: '' },
  },
  {
    key: 'comments',
    title: '游戏评论',
