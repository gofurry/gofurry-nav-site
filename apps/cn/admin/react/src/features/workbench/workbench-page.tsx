...
export function WorkbenchPage() {
  ...
  return <PageLayout>
    ...
    {auth.can('collaboration.read') && summary.collaboration && <Section title="内容储备" actions={<Link to="/collaboration" className="text-sm text-primary">打开协作中心 →</Link>}><p className="text-sm">{summary.collaboration.reserve_count} 条储备 · {summary.collaboration.researching_count} 条正在整理 · 近 30 天已落地 {summary.collaboration.landed_30d} 条</p></Section>}
