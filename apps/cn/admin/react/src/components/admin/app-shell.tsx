...
export async function logoutAndRedirect(logout: () => Promise<void>, navigate: (to: string, options: { replace: boolean }) => void) {
  await logout()
...
export function AppShell() {
  ...
  const logout = () => logoutAndRedirect(auth.logout, navigate)
