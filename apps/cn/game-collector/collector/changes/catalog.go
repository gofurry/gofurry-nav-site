...
var detectorCatalog = []Contract{
	...
	{Key: "mac_support_transition", Version: 1, SourceKind: "metric", SourceContracts: []string{"mac_support/1", "gfg_game_daily"}, DetectionPolicy: "metric_semantic_transition_v1", WatermarkPolicy: "metric_checkpoint_v1", EventCodes: []string{"mac_support_added", "mac_support_removed"}, ProcessingGrain: "day"},
