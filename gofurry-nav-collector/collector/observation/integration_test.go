...
(id,name,name_en,info,info_en,create_time,update_time,nsfw,welfare,deleted)
VALUES (1,'site','site','info','info',$1,$1,'0','0',false),
       (2,'deleted','deleted','info','info',$1,$1,'0','0',true);
