...
export const resources: ResourceConfig[] = [
  ...
  },
  {
    ...
    defaults: { name: '', name_en: '', info: '', info_en: '', resources: [{ key: '', value: '' }], groups: kvDefaults(groupKeys), release_date: '', developers: [''], publishers: [''], appid: 0, header: '', links: kvDefaults(linkKeys), weight: 1000, primary_tag: '', secondary_tag: '' },
  },
  {
    key: 'comments',
    title: '游戏评论',
