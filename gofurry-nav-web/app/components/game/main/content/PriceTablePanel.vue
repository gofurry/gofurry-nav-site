    ...
    <div class="game-stats-table relative z-[1] mt-4 overflow-hidden rounded-xl">
      ...
      <div>
        ...
        <article
          ...
          class="game-stats-row game-stats-row--placeholder grid min-h-[3.55rem] grid-cols-[2rem_minmax(0,1fr)_5.4rem] items-center gap-2 px-2 py-2 sm:grid-cols-[2.2rem_minmax(0,1fr)_5.2rem_5.2rem_4.5rem]"
