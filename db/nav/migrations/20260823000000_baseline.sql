...
COMMENT ON TABLE public."gfn_collector_observation" IS '采集观测表';
COMMENT ON COLUMN public."gfn_collector_observation"."id" IS '采集观测表id';
COMMENT ON COLUMN public."gfn_collector_observation"."site_id" IS '站点id';
COMMENT ON COLUMN public."gfn_collector_observation"."target" IS '站点域名';
COMMENT ON COLUMN public."gfn_collector_observation"."protocol" IS '采集协议';
COMMENT ON COLUMN public."gfn_collector_observation"."status" IS '采集状态';
COMMENT ON COLUMN public."gfn_collector_observation"."observed_at" IS '观测时间';
COMMENT ON COLUMN public."gfn_collector_observation"."duration_ms" IS '观测时长';
COMMENT ON COLUMN public."gfn_collector_observation"."error_code" IS '错误码';
COMMENT ON COLUMN public."gfn_collector_observation"."error_message" IS '错误信息';
COMMENT ON COLUMN public."gfn_collector_observation"."payload" IS '观测数据结果';
COMMENT ON COLUMN public."gfn_collector_observation"."schema_version" IS 'schema 版本';
COMMENT ON COLUMN public."gfn_collector_observation"."create_time" IS '创建时间';
COMMENT ON TABLE public."gfn_featured_site" IS '精选站点表';
COMMENT ON COLUMN public."gfn_featured_site"."id" IS '精选站点表id';
COMMENT ON COLUMN public."gfn_featured_site"."site_id" IS '站点id';
COMMENT ON COLUMN public."gfn_featured_site"."weight" IS '权重';
COMMENT ON COLUMN public."gfn_featured_site"."create_time" IS '创建时间';
COMMENT ON COLUMN public."gfn_featured_site"."update_time" IS '更新时间';
...
COMMENT ON TABLE public."gfn_nav_update_notice" IS '站点更新公告表';
COMMENT ON COLUMN public."gfn_nav_update_notice"."id" IS '站点更新公告表id';
COMMENT ON COLUMN public."gfn_nav_update_notice"."title" IS '更新公告标题';
COMMENT ON COLUMN public."gfn_nav_update_notice"."title_en" IS '更新公告标题 - 英文';
COMMENT ON COLUMN public."gfn_nav_update_notice"."body" IS '更新公告内容';
COMMENT ON COLUMN public."gfn_nav_update_notice"."body_en" IS '更新公告内容 - 英文';
COMMENT ON COLUMN public."gfn_nav_update_notice"."published_at" IS '发布时间';
COMMENT ON COLUMN public."gfn_nav_update_notice"."create_time" IS '创建时间';
COMMENT ON COLUMN public."gfn_nav_update_notice"."update_time" IS '更新时间';
COMMENT ON COLUMN public."gfn_nav_update_notice"."deleted" IS '软删除';
...
COMMENT ON COLUMN public."gfn_site"."view_count" IS '浏览量';
