...
The Vue frontend under `apps/cn/admin/web` remains the embedded production fallback until P0.5.2-D; no React change may silently switch production routing or delete Vue.
