...
- `gofurry-rag` and `gofurry-admin` have been updated to the new nav data and update-notice structure, without depending on the old changelog markdown / CDN flow
